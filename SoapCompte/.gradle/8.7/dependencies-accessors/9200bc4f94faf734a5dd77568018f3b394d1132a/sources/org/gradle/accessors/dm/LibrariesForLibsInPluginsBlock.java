...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class GithubLibraryAccessors extends SubDependencyFactory {
        private final GithubKsoap2LibraryAccessors laccForGithubKsoap2LibraryAccessors = new GithubKsoap2LibraryAccessors(owner);

        public GithubLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.ksoap2</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GithubKsoap2LibraryAccessors getKsoap2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGithubKsoap2LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GithubKsoap2LibraryAccessors extends SubDependencyFactory {

        public GithubKsoap2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.github.simpligility:ksoap2-android</b> coordinates and
         * with version reference <b>githubKsoap2Android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("github.ksoap2.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>githubKsoap2Android</b> with value <b>3.6.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGithubKsoap2Android() { return getVersion("githubKsoap2Android"); }
